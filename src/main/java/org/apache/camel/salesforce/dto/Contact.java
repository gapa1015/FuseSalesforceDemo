...
public class Contact extends AbstractSObjectBase {
    ...
    // Person_Typ__c
    @XStreamConverter(PicklistEnumConverter.class)
    private Person_TypEnum Person_Typ__c;

    @JsonProperty("Person_Typ__c")
    public Person_TypEnum getPerson_Typ__c() {
        return this.Person_Typ__c;
    }

    @JsonProperty("Person_Typ__c")
    public void setPerson_Typ__c(Person_TypEnum Person_Typ__c) {
        this.Person_Typ__c = Person_Typ__c;
    }
